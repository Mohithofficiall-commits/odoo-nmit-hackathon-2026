...
import { Mail, Lock, AlertCircle, CheckCircle2, CalendarClock } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 space-y-3">
            {['Track attendance with check-in / check-out', 'Apply and manage leave requests', 'View and manage payroll records', 'Role-based access for employees and HR'].map((f) => (
              <div key={f} className="flex items-center gap-2.5 text-slate-300">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 p-4 rounded-lg bg-slate-100 border border-slate-200">
            <p className="text-xs font-semibold text-slate-600 mb-2">Demo accounts (click to fill):</p>
            <div className="flex gap-2">
              ...
              >
                <div className="font-semibold text-slate-800">Admin / HR</div>
                <div className="text-slate-500">admin@dayflow.com</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-slate-500">john.davis@dayflow.com</div>
              </button>
            </div>
            <p className="text-xs text-slate-400 mt-2">Password: Dayflow2026!</p>
          </div>
